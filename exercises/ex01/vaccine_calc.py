...
pop_0 = int(pop_0)
dose_day2 = int(dose_day / 2)
dose_day2round = round(dose_day2)
doses_admin2 = int(doses_admin / 2)
doses_admin2round = round(doses_admin2)
e = int(((pop_0 * (target / 100)) - (doses_admin2round)) / (dose_day2round))
